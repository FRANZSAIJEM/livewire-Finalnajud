...
class MusicsComponent extends Component
{
    ...
    public function storeMusicData()
    {
        ...
        session()->flash('message', 'New Song has been added Successfully');
    ...
    public function editMusicData()
    {
        ...
        session()->flash('message', 'New Song has been updated Successfully');
    ...
    public function deleteMusicData()
    {
        ...
        session()->flash('message', 'Song has been deleted Successfully');
