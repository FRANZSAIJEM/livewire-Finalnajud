                            ...
                            <tbody>
                                @if ($musics->count()>0)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$music->tempo}}</td>
                                        <td>
                                            <button href="/editMusics" class="btn btn-success" wire:click='editMusics({{$music->id}})'>Edit</button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form wire:submit.prevent='storeMusicData'>
                ...
                <br>
                <div class="col-12 mt-3">
                    <button type="submit" class="btn btn-primary float-end" data-bs-dismiss="modal">Add Music</button>
                </div>
