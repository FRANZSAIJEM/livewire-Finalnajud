                        ...
                        <div class="card col-md-5 m-5 d-inline-flex shadow-lg">
                            ...
                            <div class="card-body text-center">
                                <div class="artist border border-2 p-2 rounded-pill mb-2" style="background-color: rgb(191, 219, 238)">
                                    <h3>Artist</h3>
                                    <h5 class="border rounded-pill p-2" style="background-color: rgb(165, 128, 128)">{{$music->artist_name}}</h5>
                                </div>


                                <div class="artist border border-2 p-2 rounded-pill mb-2" style="background-color: rgb(191, 219, 238)">
                                    <h3>Music Label</h3>
                                    <h5 class="border rounded-pill p-2" style="background-color: white">{{$music->label}}</h5>
                                </div>


                                <div class="artist border border-2 p-2 rounded-pill mb-2" style="background-color: rgb(191, 219, 238)">
                                    <h3>Genre</h3>
                                    <h5 class="border rounded-pill p-2" style="background-color: white">{{$music->genre}}</h5>
                                </div>

                                <div class="artist border border-2 p-2 rounded-pill mb-2" style="background-color: rgb(191, 219, 238)">
                                    <h3>Music Key</h3>
                                    <h5 class="border rounded-pill p-2" style="background-color: white">{{$music->music_key}}</h5>
                                </div>

                                <div class="artist border border-2 p-2 rounded-pill mb-2" style="background-color: rgb(191, 219, 238)">
                                    <h3>Tempo</h3>
                                    <h5 class="border rounded-pill p-2" style="background-color: white">{{$music->tempo}}</h5>
                                </div>
