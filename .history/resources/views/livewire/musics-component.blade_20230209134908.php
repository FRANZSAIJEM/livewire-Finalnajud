                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" name="" id="" class="form-control" wire:model='artist_'>
                                @error('music_id')
                                    <span class="text-danger text-lg">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                <input type="text" name="" id="music_title" class="form-control" wire:model='music_id'>
                                @error('music_id')
                                    <span class="text-danger text-lg">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                <input type="text" name="" id="record_label" class="form-control" wire:model='music_id'>
                                @error('music_id')
                                    <span class="text-danger text-lg">{{$message}}</span>
                                @enderror
                            </div>
