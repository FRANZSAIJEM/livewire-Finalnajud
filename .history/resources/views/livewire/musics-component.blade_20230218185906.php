...
<div>
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-5">
                ...
                <div class="alert alert-primary w-50 text-center shadow-sm">{{session('message')}}</div>
            @endif
                <div class="card shadow-lg ">
                    <div class="card-header">
                        <h1 class="float-start"  style="font-size: 50px"> <i class="fa fa-music"></i> Songs</h1>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card col-md-5 d-inline-flex shadow-lg m-5" >
                            <div class="card-header" style="margin-top:-50px;">
                                ...
                                <button class="btn btn-danger float-end" wire:click='deleteConfirmation({{$music -> id}})'> <i class="fa fa-trash"></i></button>
                            </div>
                            <div class="card-body text-center">
                                <div class="artist border border-2 p-2 rounded-pill mb-2" style="background-color: rgb(191, 219, 238)">
                                    <h5> <i class="fa fa-user"></i> Artist/s</h5>
  ...
  <div wire:ignore.self class="modal fade" id="deleteMusicModal" tabindex="-1" role="dialog" aria-labelledby="deleteMusicModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"> <i class="fa fa-trash"></i> Delete Confirmation</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-footer">
            <button class="btn btn-warning" data-bs-dismiss="modal" aria-label="Close"> <i class="fa fa-cancel"></i> No</button>
            <button class="btn btn-danger" wire:click='deleteMusicData()'> <i class="fa fa-remove"></i> Yes</button>
