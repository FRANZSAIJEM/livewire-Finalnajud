...
<div>
                            ...
                            <tbody>
                                @if ($musics->count()>0)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$music->tempo}}</td>
                                        <td>
                                            <button class="btn btn-success" data-toggle="modal" data-target="#editMusicModal">Edit</button>
  ...
  <div wire:ignore.self class="modal fade" id="editMusicModal" tabindex="-1" role="dialog" aria-labelledby="addMusicModalLabel" aria-hidden="true">
