...
<div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card col-md-5 d-inline-flex shadow-lg m-5" >
                            ...
                            <div class="card-footer text-center">
                                <button class="btn p-3 border border-success" wire:click='editMusics({{$music -> id}})'> <i class="fa fa-edit"></i> Edit</button>
                                <button class="btn p-3 border border-danger" wire:click='deleteConfirmation({{$music -> id}})'> <i class="fa fa-remove"></i> Delete</button>
                            </div>
                        </div>
                        @endforeach
                    @endif
  ...
  <div class="mt-1" wire:ignore.self class="modal fade " id="addMusicModal" tabindex="-1" role="dialog" aria-labelledby="addMusicModalLabel" aria-hidden="true">
  ...
  <style>
    .card-header, .modal-header, .card-footer{
