            ...
            <div class="col-md-12">
                <div class="card shadow-lg mt">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card col-md-5 m-5 d-inline-flex shadow-lg">
                            <div class="card-header">
                                <h1 class="text-center">  <i class="fa-brands fa-itunes-note"></i> {{$music->music_title}}</h1>
                            </div>
                            <div class="card-body text-center">
                                <div class="artist border border-2 p-2 rounded-pill mb-2" style="background-color: rgb(191, 219, 238)">
                                    <h3> <i class="fa fa-user"></i> Artist</h3>
                                    <h5 class="border rounded-pill p-2" style="background-color: rgba(255, 255, 255, 0.403)">{{$music->artist_name}}</h5>
                                </div>


                                <div class="artist border border-2 p-2 rounded-pill mb-2" style="background-color: rgb(191, 219, 238)">
                                    <h3> <i class="fa-solid fa-record-vinyl"></i> Music Label</h3>
                                    <h5 class="border rounded-pill p-2" style="background-color: rgba(255, 255, 255, 0.403)">{{$music->label}}</h5>
                                </div>


                                <div class="artist border border-2 p-2 rounded-pill mb-2" style="background-color: rgb(191, 219, 238)">
                                    <h3> <i class="fa-brands fa-renren"></i> Genre</h3>
                                    <h5 class="border rounded-pill p-2" style="background-color: rgba(255, 255, 255, 0.403)">{{$music->genre}}</h5>
                                </div>

                                <div class="artist border border-2 p-2 rounded-pill mb-2" style="background-color: rgb(191, 219, 238)">
                                    <h3> <i class="fa-solid fa-key"></i> Music Key</h3>
                                    <h5 class="border rounded-pill p-2" style="background-color: rgba(255, 255, 255, 0.403)">{{$music->music_key}}</h5>
                                </div>

                                <div class="artist border border-2 p-2 rounded-pill mb-2" style="background-color: rgb(191, 219, 238)">
                                    <h3> <i class="fa-solid fa-arrow-down-wide-short"></i> Tempo</h3>
                                    <h5 class="border rounded-pill p-2" style="background-color: rgba(255, 255, 255, 0.403)">{{$music->tempo}}</h5>
                                </div>
